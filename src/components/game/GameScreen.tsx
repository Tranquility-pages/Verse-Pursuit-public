        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center"
          ...
          >
            ...
            <div className="w-full max-w-sm mx-4 h-full flex flex-col py-2 lg:hidden">
              ...
              {/* Bible Verse Section - Fully transparent container */}
              {gameState.round.currentVerse && (
                <div className="text-center mb-6 mx-4 flex-1 flex flex-col justify-center bg-transparent" style={{ marginTop: '-30px' }}>
            ...
            <div className="hidden lg:flex w-full max-w-4xl mx-8 h-full flex-col justify-center py-12">
              ...
              {/* Bible Verse Section - Fully transparent container */}
              {gameState.round.currentVerse && (
                <div className="text-center mb-8 mx-8 bg-transparent">
                  <h3 className="font-bold text-black mb-4 text-2xl">{gameState.round.currentVerse.reference}</h3>
                  <p className="text-xl text-gray-700 leading-relaxed max-w-2xl mx-auto bg-transparent p-6">
                    {gameState.round.currentVerse.text}
                  </p>
                </div>
              )}
